...
import { popUpImage, popUpImagePicture, popUpImageCaption } from './index.js';
...
class Card {
    ...
    _addOpenImagePopupListener(template) {
        ...
        console.log(popUpImagePicture.src);
    }
    ...
    generateCard() {
        ...
        this._addOpenImagePopupListener(this._template, item);
